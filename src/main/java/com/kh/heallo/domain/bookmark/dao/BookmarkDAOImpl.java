...
public class BookmarkDAOImpl implements BookmarkDAO{
    ...
    public List<Facility> bookmarkPageList(String order,Long memno) {
        ...
        sql.append("   from BOOKMARK, FACILITY ");
        sql.append("  where BOOKMARK.FCNO=FACILITY.FCNO and BOOKMARK.memno = ? ");
        sql.append("  order by " + order + " ");

        List<Facility> bookmarks = jdbcTemplate.query(sql.toString(), new BeanPropertyRowMapper<>(Facility.class),memno);
